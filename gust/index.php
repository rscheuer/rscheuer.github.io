...
<head>
	...
	<style type="text/css">
		@font-face {
		    font-family: 'Gust'; /*a name to be used later*/
		    src: url('Gust-Regular.otf'); /*URL to font*/
		}
	    input:focus,
	    textarea:focus,
	    p:focus {
	...
	<div class="info-instagram"><span id="show-info"><a>Info</a></span></span>
		...
		<div class="wrap">
			...
			<div class="right project-column">
				<p class="project-title">4. Gust Typeface</p>

				<div id="rightcol">
					<div class="columns">
						<div class="column">
							<img class="lazy" src="./gust-header.png" alt="" />
						</div>
					</div>

					<div class="small-text"><p>RS / 2019</p><span>Personal </span><span><b>Type Design</b></span></div>
					<div class="project-body">
						<p>Gust is a super wide display face.  It features a much wider upper case with the same height, so you can mix it up!</p>

						<p>Check out the image below to see some cool letter variations.</p>

						<p id='myP'>TeST it OUt HErE</p>

						<br>

						<a href="Gust-Regular.otf" target="_blank"><b>Free download</b></a>
						<br>
						<br>
					...
					<div class="columns">
						<div class="column"><img class="lazy" src="./gust-width-demo.png" alt="" /></div>
					</div>
