...
$(window).scroll(function () {
	// Setting: Start shrinking halfway up the page
	var startPos = 0.2;

	// Cache window object
	var $w = $(window);

	// Basically, go through each element and check its relative position within the viewport
	$(".stack__card").each(function () {
        ...
        // console.log(s);
		if (pos < vh * startPos) {
			// If element has past the starting threshold, scale
