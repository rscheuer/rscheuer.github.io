...
<head>
	...
	<style type="text/css">
		@font-face {
		    font-family: 'Oatmeal'; /*a name to be used later*/
		    src: url('OatmealRS-Regular.otf'); /*URL to font*/
		}
	    input:focus,
	    textarea:focus,
	    p:focus {
	...
	<div class="info-instagram"><span id="show-info"><a>Info</a></span></span>
		...
		<div class="wrap">
			...
			<div class="right project-column">
				<p class="project-title">7. Oatmeal Typeface</p>

				<div id="rightcol">
					<div class="columns">
						<div class="column">
							<img class="lazy" src="./oatmeal-header.png" alt="" />
						</div>
					</div>

					<div class="small-text"><p>RS / 2019</p><span>Personal </span><span><b>Type Design</b></span></div>
					<div class="project-body">
						<p>Oatmeal is another nu blackletter inspired font.  It features a full upper and lowercase as well as numbers and a few symbols.  The uppercase is super complex and makes for great title lettering and tattoos.</p>
						...
						<a href="OatmealRS-Regular.otf" target="_blank"><b>Free download</b></a>
						<br>
						<br>
					...
					<div class="columns">
						<div class="column"><img src="./oatmeal-1.png" alt="" /></div>
					</div>

					<div class="columns">
						<div class="column"><img class="lazy" src="./oatmeal-2.png" alt="" /></div>
					</div>
