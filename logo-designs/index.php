...
<body class="body-font">
	...
	<div class="wrap">
		...
		<div class="right project-column">
			<p class="project-title">3. Logo Designs</p>
			
			<div id="rightcol">
				<img class="lazy" src="../img/412works.png" alt="" />
				
				<div class="small-text"><p>RS / 2018</p><span>For </span><span><b>Various</b></span></div>
				<div class="project-body">
					<p>A collection of logos and commercial work I've done recently.</p>
				</div>
				
				<div class="columns">
					<div class="column"><img src="../img/steelcityr.png" alt="" />
					</div>
					<div class="column"><img src="../img/arnold-painting.png" alt="" />
					</div>
				</div>
				<div class="columns is-mobile">
					<div class="column"></div>
					<div class="column"><img class="lazy" src="../img/kk-spin.gif" alt="" /><div class="small-text"><p>RS / 2018</p><span>For </span><span><b>Kristiankirk</b></span></div></div>
					<div class="column"></div>
				</div>
				
				<div class="columns">
					<div class="column"><img class="lazy" src="../img/sfs.png" alt="" /></div>
				</div>
